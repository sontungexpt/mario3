...
#define MARIO_BIG_TAIL_SUIT_BBOX_WIDTH_ADJUST_HITTING 8
...
#define MARIO_ACCURACY_LEVEL_WHEN_HITTING 8
...
#define MARIO_FLY_FALLING_SPEED		0.24f
...
#define MARIO_TRY_FLYING_SPEED_Y	0.16f
